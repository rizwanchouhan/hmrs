...
class TrainOptions():
    def __init__(self):
        ...
        train.add_argument('--regressor', type=str, choices=['hmr', 'hmrs'], default='hmrs', help='Name of the SMPL regressor.')
        train.add_argument('--cfg_file', type=str, default='./configs/emo_pose.yaml', help='config file path for HMRS.')
