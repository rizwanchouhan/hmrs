...
H36M_ROOT = join('/home/abbas/HMRS/datasets/preprocess', 'Datasets/h36m')
...
COCO_ROOT = join('/home/abbas/HMRS/datasets/preprocess', 'coco')
MPI_INF_3DHP_ROOT = join('/opt/data/private/datasets',
                         'Datasets/mpi_inf_3dhp_train_set')
PW3D_ROOT = join('/home/abbas/HMRS/datasets/preprocess', '3dpw')
