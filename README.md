...
<table>
  ...
  <tr>
    ...
    <td style="text-align: center;">
      <p>Reconstruction</p>
      <img width="180" src="https://github.com/rizwanchouhan/hmrs/blob/main/resources/Picture2.png" alt="Foreground">
    </td>
        <td style="text-align: center;">
      <p>Input Image</p>
      <img width="180" src="https://github.com/rizwanchouhan/hmrs/blob/main/resources/Picture3.png="input video">
    </td>
    <td style="text-align: center;">
      <p>Reconstruction</p>
    ...
    <td style="text-align: center;">
      <p>Reconstruction</p>
      <img width="180" src="https://github.com/rizwanchouhan/hmrs/blob/main/resources/Picture6.png" alt="Foreground">
    </td>
        <td style="text-align: center;">
      <p>Input Image</p>
      <img width="180" src="https://github.com/rizwanchouhan/hmrs/blob/main/resources/Picture7.png" alt="input video">
    </td>
    <td style="text-align: center;">
      <p>Reconstruction</p>
