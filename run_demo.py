...
def run_image_demo(args):
    ...
    with torch.no_grad():
        if args.regressor == 'hmr-spin':
            ...
            # Run HMRS model to predict body parameters
    ...
    cv2.imwrite(save_name + '_hmrs.png', img_shape)
    cv2.imwrite(save_name + '_hmrs_side.png', img_shape_side)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--staf_dir', type=str, default='/home/abbas/HMRS/STAF/',
