...
# Argument to provide the path to the configuration file for HMRS. Default is 'configs/emo_pose.yaml'.
parser.add_argument('--cfg_file', type=str, default='configs/emo_pose.yaml', help='Config file path for HMRS.')
